    ...
    return (
        <div className='bg-black my-10 flex lg:flex-row flex-col-reverse items-center lg:py-0 py-2 justify-between mx-5'>
            <div className='text-left lg:w-1/2 px-8'>
                ...
                <p className='text-gray-300 lg:text-base text-sm mb-4'>Download the app now for seamless budgeting, real-time insights, and smart savings tools. Start managing your finances effortlessly today!</p>
